  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-zinc-50 via-white to-zinc-100 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
        ...
        <div className="mx-auto flex max-w-5xl items-center gap-3 px-4 py-2.5">
          ...
          <div>
            ...
            <p className="text-[11px] leading-tight text-muted-foreground">
              Talk it through with a supportive AI
            </p>
          </div>
      ...
      <main className="relative overflow-hidden">
        <div
          className="pointer-events-none absolute -top-24 -left-24 h-96 w-96 rounded-full bg-rose-400/20 blur-3xl dark:bg-rose-500/10"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute top-1/3 -right-32 h-96 w-96 rounded-full bg-pink-500/20 blur-3xl dark:bg-pink-500/10"
          aria-hidden
        />
        <div
            ...
            >
              ...
              <div className="max-w-md">
                <p className="text-lg font-semibold">
                  {resolveErrorCopy(s.errorCode).title}
                </p>
                <p className="mt-1 text-sm text-muted-foreground">
                  {s.error ?? resolveErrorCopy(s.errorCode).message}
                </p>
              </div>
