...
const SUPPORT_CHIPS = [
  "Live voice help",
  "Coding · mental · guidance",
  "Share your screen",
  "10-minute sessions",
];
const REVIEWER_CHIPS = [
  "Github + live link",
  "Structure + naming",
  "SEO + accessibility",
...
const PIXEL_CHIPS = [
  "27 challenges · navbars → whole pages",
  "Scored in a real browser",
  "Diff & slide compare",
  "Unlock the run",
];
    ...
    >
      <Reveal className="text-center">
        <h2 className="text-2xl font-bold sm:text-3xl">
          Seven labs. One goal: make it click.
        </h2>
        <p className="mx-auto mt-2 max-w-xl text-sm text-muted-foreground sm:text-base">
          Every concept here is something you run, watch, or say — not just
          something you read.
        </p>
      </Reveal>
