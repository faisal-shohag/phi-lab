  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-zinc-50 via-white to-zinc-100 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
      ...
      <main className="relative overflow-hidden">
        <div
          className="pointer-events-none absolute -top-24 -left-24 h-96 w-96 rounded-full bg-indigo-400/20 blur-3xl dark:bg-indigo-500/10"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute top-1/3 -right-32 h-96 w-96 rounded-full bg-emerald-500/20 blur-3xl dark:bg-emerald-500/10"
          aria-hidden
        />
        <div
          className="pointer-events-none absolute bottom-0 left-1/4 h-72 w-72 rounded-full bg-sky-400/10 blur-3xl dark:bg-sky-500/10"
          aria-hidden
        />
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Checking clarity, gaps and what your student learned.
                </p>
              </div>
            </motion.div>
          )}
          ...
          {fx.phase === "report" && fx.report && (
            ...
            >
              <ReportScreen
                ...
                onNew={fx.reset}
                onRetry={() => {
                  if (fx.concept) fx.enterGreenRoom(fx.concept);
                }}
              />
            </motion.div>
          )}
          ...
          {fx.phase === "error" && (
            ...
            >
              ...
              <div className="max-w-md">
                <p className="text-lg font-semibold">
                  {resolveErrorCopy(fx.errorCode).title}
                </p>
                <p className="mt-1 text-sm text-muted-foreground">
                  {fx.error ?? resolveErrorCopy(fx.errorCode).message}
                </p>
              </div>
              <div className="flex items-center gap-2">
                ...
                <Button
                  variant={
                    fx.errorCode === "REPORT_FAILED" ? "outline" : "default"
                  }
                  onClick={fx.reset}
                >
                  Back to start
