          ...
          <div className="mx-auto flex max-w-md flex-col items-center gap-4 px-4 py-16 text-center">
            <p className="text-lg font-semibold">
              {session.status === "FAILED"
                ? "This teach-back was not scored"
                : "This teach-back has no report yet"}
            </p>
            <p className="text-sm text-muted-foreground">
              Your explanation is saved.
            </p>
          </div>
        )}
              ...
              {transcript.map((t, i) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={cn(
                        "mb-0.5 px-1 text-[10px] font-semibold uppercase tracking-wide",
                        isTeacher ? "text-sky-500" : "text-violet-500",
                      )}
                    >
